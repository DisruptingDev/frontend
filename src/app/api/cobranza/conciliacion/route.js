...
async function obtenerSiguienteFolioSerie(emisorId) {
...
async function crearEstructuraCompletaCFDI({ comprobante, emisor, receptor, descripcionConcepto, monto, grupoId }) {
            ...
            if (action === 'ASIGNAR_MANUAL') {
                ...
                const comprobanteAuto = await prisma.comprobantes.create({
                    data: sanitizeNullBytes({
                        ...
                        sub_total: montoNum,
                        sub_total_string: String(Number(montoNum).toFixed(2)),
                        total: montoNum,
                        total_string: String(Number(montoNum).toFixed(2)),
                        descuento: 0,
                        descuento_string: '0',
                        estatus: 'PENDIENTE'
                    })
