export default function FormatearFactura(data, id = null, facturasRelacionadas = null) {
        ...
        return {
            ...
            Impuestos: {
                Retenciones: impuestos.Tipo === "Retencion" ? [
                    {
                        Base: Number(parseFloat(impuestos.BaseImpuesto || 0).toFixed(2)),
                ...
                Traslados: impuestos.Tipo === "Traslado" ? [
                    {
                        Base: Number(parseFloat(impuestos.BaseImpuesto || 0).toFixed(2)),
                        BaseString: String(parseFloat(impuestos.BaseImpuesto || 0).toFixed(2)),
                        ImpuestoCatalogoID: impuestos.ImpuestoClaveID,
                        ImpuestoClave: String(impuestos.ClaveImpuesto || ""),
                        TipoFactor: "Tasa",
                        TasaOCuota: Number(parseFloat(tasaOCuota).toFixed(2)),
    ...
    const factura = {
        ...
        ...(facturasRelacionadas &&
            ...
            CFDIRelacionados: {
                ...
                ListaCFDIRelacionados: facturasRelacionadas.ListaCFDIRelacionados.map((uuidObj) => ({
                    UUID: uuidObj.UUID,
                })),
            },
        } : {}),
