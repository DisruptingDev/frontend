export default function FormatearFactura(
  ...
  if (modo == "Factura") {
    ...
    factura = {
      ...
      Descripcion: emisor.Observaciones || receptor.Observaciones || emisor.DescripcionComprobante || receptor.DescripcionComprobante || (emisor.Descripcion !== conceptos?.[0]?.Descripcion ? (emisor.Descripcion || "") : "") || "",
      Observaciones: emisor.Observaciones || receptor.Observaciones || "",
