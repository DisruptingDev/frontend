...
const sources = {
  json: [
    ...
    // Importing dynamically to replace require
    await import('@iconify/json/json/ri.json').then(module => module.default)
  ],
  svg: [
    {
...
;(async function () {
  ...
  if (sources.icons) {
    ...
    for (const prefix in organizedList) {
      const filename = join('@iconify/json/json', `${prefix}.json`);
